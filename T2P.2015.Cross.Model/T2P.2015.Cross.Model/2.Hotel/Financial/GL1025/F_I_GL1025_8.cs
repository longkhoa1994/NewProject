...
{
    [Serializable]
    public class F_I_GL1025_8 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_GL1025_8"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_GL1025_8_InsertOrUpdate"; } }
    }
    public enum F_I_GL1025_8Columns
    {
        ID,
        F_I_GL1025_0ID,
        RecordType,
    ...
    public enum F_I_GL1025_8Procedure
    {

    }
    public class F_I_GL1025_8List : List<F_I_GL1025_8>
    {
