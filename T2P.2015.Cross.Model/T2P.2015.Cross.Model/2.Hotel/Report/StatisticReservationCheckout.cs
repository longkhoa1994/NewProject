...
namespace T2P._2015.Cross.Model.Report
{
    ...
    public class P_StatisticReservationCheckout
    {
        ...
        private long numberCheckoutHasInv;

        public long NumberCheckoutHasInv
        {
            get { return numberCheckoutHasInv; }
            set { numberCheckoutHasInv = value; }
        }
        ...
        public long HasInvoiceCallCol { get; set; }
        public decimal HasInvoiceCallColPercent { get; set; }

        public long HasInvoiceCallRej { get; set; }
        public decimal HasInvoiceCallRejPercent { get; set; }
        ...
        private long waitingForInvPercent;

        public long WaitingForInvPercent
        {
            get { return waitingForInvPercent; }
            set { waitingForInvPercent = value; }
        }
        ...
        public long ProcessingPercent
        {
            get { return processingPercent; }
            set { processingPercent = value; }
        }
        private long enrichedPercent;

        public long EnrichedPercent
        {
            get { return enrichedPercent; }
            set { enrichedPercent = value; }
        }
        private long specialCasesPercent;

        public long SpecialCasesPercent
        {
            get { return specialCasesPercent; }
            set { specialCasesPercent = value; }
        }
        ...
        private long numberCheckoutOfWaitingFIN;

        public long NumberCheckoutOfWaitingFIN
        {
            get { return numberCheckoutOfWaitingFIN; }
            set { numberCheckoutOfWaitingFIN = value; }
        }


        private long numberCheckoutOfWaitingFINNet;

        public long NumberCheckoutOfWaitingFINNet
        {
            get { return numberCheckoutOfWaitingFINNet; }
            set { numberCheckoutOfWaitingFINNet = value; }
        }


        private decimal numberCheckoutOfWaitingFINPercent;

        public decimal NumberCheckoutOfWaitingFINPercent
        {
            get { return numberCheckoutOfWaitingFINPercent; }
            set { numberCheckoutOfWaitingFINPercent = value; }
        }
        private long numberCallRejection;

        public long NumberCallRejection
        {
            get { return numberCallRejection; }
            set { numberCallRejection = value; }
        }
        private decimal numberCallRejectionPercent;

        public decimal NumberCallRejectionPercent
        {
            get { return numberCallRejectionPercent; }
            set { numberCallRejectionPercent = value; }
        }
        private long numberCallCollection;

        public long NumberCallCollection
        {
            get { return numberCallCollection; }
            set { numberCallCollection = value; }
        }
        private decimal numberCallCollectionPercent;

        public decimal NumberCallCollectionPercent
        {
            get { return numberCallCollectionPercent; }
            set { numberCallCollectionPercent = value; }
        }

        public long NotInvoiceCallCol { get; set; }
        public decimal NotInvoiceCallColPercent { get; set; }
     
        public long NotInvoiceCallRej { get; set; }
        public decimal NotInvoiceCallRejPercent { get; set; }
    ...
    public enum StatisticReservationCheckoutProcedure
    {
        ...
        p_Report_Statistic_Reservation_Checkout_v2,
    }
}
