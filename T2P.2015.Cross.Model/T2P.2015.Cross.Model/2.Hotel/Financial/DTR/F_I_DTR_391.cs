...
{
    [Serializable]
    public class F_I_DTR_391 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long? _f_I_DTR_390ID;
        public long? F_I_DTR_390ID
        {
            get { return _f_I_DTR_390ID; }
            set { _f_I_DTR_390ID = value; }
        }
        ...
        public override string Table { get { return "F_I_DTR_391"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_391_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_391Columns
    {
        ID,
        F_I_DTR_390ID,
        RecordType,
    ...
    public enum F_I_DTR_391Procedure
    {
        p_F_I_DTR_391_GetBy_F_I_DTR_390ID
    }
    public class F_I_DTR_391List : List<F_I_DTR_391>
    {
