...
{
    [Serializable]
    public class F_E_SBF_4 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long _f_E_SBF_5ID;
        public long F_E_SBF_5ID
        {
            get { return _f_E_SBF_5ID; }
            set { _f_E_SBF_5ID = value; }
        }
        ...
        {
            get { return _departureLocationID; }
            set { _departureLocationID = value; }
        }
        ...
        public override string Table { get { return "F_E_SBF_4"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_SBF_4_InsertOrUpdate"; } }
    }
    public enum F_E_SBF_4Columns
    {
        ID,
        F_E_SBF_5ID,
        RecordTypeId,
    ...
    public enum F_E_SBF_4Procedure
    {
        p_F_E_SBF_4_GetFromImportFIN,
        p_F_E_SBF_4_GetBySBF_2ID,
    }
    public class F_E_SBF_4List : List<F_E_SBF_4>
    {
