...
{
    [Serializable]
    public class F_I_GL1025_3 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_GL1025_3"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_GL1025_3_InsertOrUpdate"; } }
    }
    public enum F_I_GL1025_3Columns
    {
        ID,
        F_I_GL1025_1ID,
        RecordType,
    ...
    public enum F_I_GL1025_3Procedure
    {

    }
    public class F_I_GL1025_3List : List<F_I_GL1025_3>
    {
