...
{
    [Serializable]
    public class F_I_DTR_342 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_342"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_342_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_342Columns
    {
        ID,
        F_I_DTR_341ID,
        RecordType,
    ...
    public enum F_I_DTR_342Procedure
    {
        p_F_I_DTR_342_GetBy_F_I_DTR_341ID
    }
    public class F_I_DTR_342List : List<F_I_DTR_342>
    {
