...
{
    [Serializable]
    public class F_I_DTR_351 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long? _f_I_DTR_350ID;
        public long? F_I_DTR_350ID
        {
            get { return _f_I_DTR_350ID; }
            set { _f_I_DTR_350ID = value; }
        }
        ...
        public override string Table { get { return "F_I_DTR_351"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_351_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_351Columns
    {
        ID,
        F_I_DTR_350ID,
        RecordType,
    ...
    public enum F_I_DTR_351Procedure
    {
        p_F_I_DTR_351_GetBy_F_I_DTR_350ID
    }
    public class F_I_DTR_351List : List<F_I_DTR_351>
    {
