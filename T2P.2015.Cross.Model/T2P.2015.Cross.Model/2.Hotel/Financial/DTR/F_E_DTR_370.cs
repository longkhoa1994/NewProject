...
{
    [Serializable]
    public class F_E_DTR_370 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_E_DTR_370"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_370_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_370Columns
    {
        ID,
        F_E_DTR_320ID,
        RecordType,
    ...
    public enum F_E_DTR_370Procedure
    {
        p_F_E_DTR_370_GetBy_F_E_DTR_320ID
    }
    public class F_E_DTR_370List : List<F_E_DTR_370>
    {
