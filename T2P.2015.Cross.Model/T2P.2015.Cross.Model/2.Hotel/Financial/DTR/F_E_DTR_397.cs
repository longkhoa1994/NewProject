...
{
    [Serializable]
    public class F_E_DTR_397 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_E_DTR_397"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_397_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_397Columns
    {
        ID,
        F_E_DTR_320ID,
        RecordType,
    ...
    public enum F_E_DTR_397Procedure
    {
        p_F_E_DTR_397_GetBy_F_E_DTR_320ID
    }
    public class F_E_DTR_397List : List<F_E_DTR_397>
    {
