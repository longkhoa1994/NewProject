...
{
    [Serializable]
    public class F_I_DTR_340 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_340"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_340_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_340Columns
    {
        ID,
        F_I_DTR_320ID,
        RecordType,
    ...
    public enum F_I_DTR_340Procedure
    {
        p_F_I_DTR_340_GetBy_F_I_DTR_320ID
    }
    public class F_I_DTR_340List : List<F_I_DTR_340>
    {
