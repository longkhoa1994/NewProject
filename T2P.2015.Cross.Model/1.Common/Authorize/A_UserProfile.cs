...
namespace T2P._2015.Cross.Model
{
    ...
    public class A_UserProfile : BaseModel
    {
        ...
        public int IsUserOverviewHRS { get; set; }
    ...
    public class P_Update_UserPermission : A_UserProfile
    {
    ...
    public enum A_UserProfileProcedure
    {
        ...
        p_A_UserProfile_GetList_UserLimit_RentalCar,
        p_A_UserProfile_GetAllCaller,
        p_A_UserProfile_GetAllISCCaller,
        ...
        p_A_UserProfile_GetList_ForHotelGateway,
        p_A_UserProfile_GetUserImportBooking,
        p_A_UserProfile_Get_ForAssignList,
        p_A_UserGroup_GetListByA_GroupID,
        p_A_UserProfile_Get_ByID,
        p_A_UserProfile_GetUserImport_Invoice_RC,
        p_A_UserProfile_GetUserImport_Booking_ECS
    }
