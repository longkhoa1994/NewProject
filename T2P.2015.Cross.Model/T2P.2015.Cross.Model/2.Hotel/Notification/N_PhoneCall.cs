...
namespace T2P._2015.Cross.Model
{
    ...
    public enum N_PhoneCallProcedure
    {
        ...
        p_N_PhoneCall_Get_ByBooking_ForServiceDeskRC,
        p_N_PhoneCall_GetBy_Task,
        p_N_PhoneCall_Get_Search,
        p_N_PhoneCall_Get_SearchForItelya,
        p_N_PhoneCall_GetListForDeleting,
        p_N_PhoneCall_Get_SearchTodayByUserID,
        p_N_PhoneCall_GetList_ByM_HotelID,
        p_N_PhoneCall_GetList_ByListHotelID,
        p_N_PhoneCall_Get_CalledHotels
    }
