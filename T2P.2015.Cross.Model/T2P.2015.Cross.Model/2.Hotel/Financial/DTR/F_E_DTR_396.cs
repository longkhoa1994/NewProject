...
{
    [Serializable]
    public class F_E_DTR_396 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_E_DTR_396"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_396_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_396Columns
    {
        ID,
        F_E_DTR_320ID,
        RecordType,
    ...
    public enum F_E_DTR_396Procedure
    {
        p_F_E_DTR_396_GetBy_F_E_DTR_320ID
    }
    public class F_E_DTR_396List : List<F_E_DTR_396>
    {
