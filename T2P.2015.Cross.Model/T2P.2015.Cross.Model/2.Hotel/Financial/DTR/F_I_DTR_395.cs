...
{
    [Serializable]
    public class F_I_DTR_395 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_395"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_395_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_395Columns
    {
        ID,
        F_I_DTR_320ID,
        RecordType,
    ...
    public enum F_I_DTR_395Procedure
    {
        p_F_I_DTR_395_GetBy_F_I_DTR_320ID
    }
    public class F_I_DTR_395List : List<F_I_DTR_395>
    {
