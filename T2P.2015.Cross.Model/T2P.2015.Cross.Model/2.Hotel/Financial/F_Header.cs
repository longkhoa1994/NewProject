...
namespace T2P._2015.Cross.Model
{
    ...
    { 
        ...
        public List<F_TransactionImport> ListFinUpdatedDBI { get; set; }
        public F_HeaderImport()
        {
            ListFinTransaction = new List<F_Transaction>();
            ListFinUpdatedDBI = new List<F_TransactionImport>();
        }
    }
    ...
    public enum F_HeaderProcedure
    {
        ...
        p_F_Header_GetList_ByTransactionID,
        p_F_Get_F_Header_By_ImportFileID,
        p_F_Header_GetBy_CompanyIdentifier_SequenceID
    }
