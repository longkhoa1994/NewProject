...
{
    [Serializable]
    public class F_I_DTR_402 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_402"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_402_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_402Columns
    {
        ID,
        F_I_DTR_310ID,
        RecordType,
    ...
    public enum F_I_DTR_402Procedure
    {
        p_F_I_DTR_402_GetBy_F_I_DTR_310ID
    }
    public class F_I_DTR_402List : List<F_I_DTR_402>
    {
