...
namespace T2P._2015.Cross.Model
{
    ...
    public class M_InvoiceErrorCode : BaseModel
    {
        ...
        {
            get { return _isFinalCheck; }
            set { _isFinalCheck = value; }
        }
    ...
    public enum M_InvoiceErrorCodeProcedure
    {
        ...
        p_M_InvoiceErrorCode_Get_ByGroup,
        p_M_InvoiceErrorCode_Get_ForFinalCheck,
        p_M_InvoiceErrorCode_Get_TranslationForFilter,
        p_M_InvoiceErrorCode_GetByImageID,
        p_M_InvoiceErrorCode_GetByImage
    }
