...
{
    [Serializable]
    public class F_I_SBF_7 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long _f_I_SBF_2ID;
        public long F_I_SBF_2ID
        {
            get { return _f_I_SBF_2ID; }
            set { _f_I_SBF_2ID = value; }
        }
        ...
        public override string Table { get { return "F_I_SBF_7"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_SBF_7_InsertOrUpdate"; } }
    }
    public enum F_I_SBF_7Columns
    {
        ID,
        F_I_SBF_2ID,
        RecordTypeID,
    ...
    public enum F_I_SBF_7Procedure
    {
        p_F_I_SBF_7_GetByTransactionId
    }
    public class F_I_SBF_7List : List<F_I_SBF_7>
    {
