...
namespace T2P._2015.Cross.Model
{
    ...
    public class B_Suggestion:BaseModel
    {
        ...
        public override string Table { get { return "B_Suggestion"; } }
    ...
    public enum B_SuggestionProcedure
    {
        ...
        p_B_Suggestion_GetList_ByM_HotelID,
        p_B_Suggestion_GetList_By_ListHotelID,
        p_B_Suggestion_GetList_ByN_BillingEmailID
    }
}
