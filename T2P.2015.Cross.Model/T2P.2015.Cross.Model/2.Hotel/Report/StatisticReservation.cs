...
namespace T2P._2015.Cross.Model.Report
{
    ...
    public class P_StatisticReservationCountryInfor
    {
    ...
    public class CountryInfor
    {
        ...
        public List<Years> ListYearForCountry { get; set; }

        public long Summary { get; set; }

        public CountryInfor()
        {
            ListYearForCountry = new List<Years>();
        }
    }
    ...
    public class CountryForYear
    {
        public List<CountryInfor> ListCountryInfor { get; set; }
        public List<string> ListYear { get; set; }
        // public List<string> ListSum { get; set; }

        public CountryForYear()
        {
            ListCountryInfor = new List<CountryInfor>();
            ListYear = new List<string>();
            //ListSum = new List<string>();
        }
    ...
    public enum StatisticReservationStoreProcedure
    {
        ...
        //p_Report_Statistic_Reservation_Country,
        p_Report_Statistic_Reservation_Country,
    }
}