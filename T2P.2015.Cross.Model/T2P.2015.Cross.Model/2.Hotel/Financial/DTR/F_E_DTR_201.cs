...
{
    [Serializable]
    public class F_E_DTR_201 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long? _F_E_DTR_101ID;
        public long? F_E_DTR_101ID
        {
            get { return _F_E_DTR_101ID; }
            set { _F_E_DTR_101ID = value; }
        }
        ...
        public override string Table { get { return "F_E_DTR_201"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_201_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_201Columns
    {
        ID,
        F_E_DTR_101ID,
        RecordType,
    ...
    public enum F_E_DTR_201Procedure
    {
        p_F_E_DTR_201_GetBy_F_E_DTR_101ID
    }
    public class F_E_DTR_201List : List<F_E_DTR_201>
    {
