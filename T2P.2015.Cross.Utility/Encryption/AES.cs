...
namespace T2P._2015.Cross.Utility.Encryption
{
    ...
    {
        // Change these keys
        private string Key = ";.^XBCs.S!Lh/fp9g*Wt";
        private string Vector = "`a!ZVOh:1Vy&J2P#a$5,";
        ...
        public AES()
        {
            ...
            Rfc2898DeriveBytes key = new Rfc2898DeriveBytes(Vector, salt);
            myAlg.Key = key.GetBytes(myAlg.KeySize / 8);
            myAlg.IV = key.GetBytes(myAlg.BlockSize / 8);

            //Create an encryptor and a decryptor using our encryption method, key, and vector.
            EncryptorTransform = rm.CreateEncryptor(myAlg.Key, myAlg.IV);
            DecryptorTransform = rm.CreateDecryptor(myAlg.Key, myAlg.IV);
