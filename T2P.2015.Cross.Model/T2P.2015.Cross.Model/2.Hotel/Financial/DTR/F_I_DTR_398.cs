...
{
    [Serializable]
    public class F_I_DTR_398 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_398"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_398_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_398Columns
    {
        ID,
        F_I_DTR_320ID,
        RecordType,
    ...
    public enum F_I_DTR_398Procedure
    {
        p_F_I_DTR_398_GetBy_F_I_DTR_320ID
    }
    public class F_I_DTR_398List : List<F_I_DTR_398>
    {
