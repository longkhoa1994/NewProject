...
{
    [Serializable]
    public class F_E_DTR_999 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_E_DTR_999"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_999_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_999Columns
    {
        ID,
        F_E_DTR_101ID,
        RecordType,
    ...
    public enum F_E_DTR_999Procedure
    {
        p_F_E_DTR_999_GetBy_F_E_DTR_101ID
    }
    public class F_E_DTR_999List : List<F_E_DTR_999>
    {
