...
{
    [Serializable]
    public class F_E_SBF_8 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long _f_E_SBF_1ID;
        public long F_E_SBF_1ID
        {
            get { return _f_E_SBF_1ID; }
            set { _f_E_SBF_1ID = value; }
        }
        ...
        public override string Table { get { return "F_E_SBF_8"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_SBF_8_InsertOrUpdate"; } }
    }
    public enum F_E_SBF_8Columns
    {
        ID,
        F_E_SBF_1ID,
        RecordTypeID,
    ...
    public enum F_E_SBF_8Procedure
    {
        p_F_E_SBF_8_GetBySBF_1ID
    }
    public class F_E_SBF_8List : List<F_E_SBF_8>
    {
