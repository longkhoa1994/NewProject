...
{
    [Serializable]
    public class F_I_SBF_5 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public long F_I_SBF_2ID { get; set; }
        ...
        public override string Table { get { return "F_I_SBF_5"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_SBF_5_InsertOrUpdate"; } }
    }
    public enum F_I_SBF_5Columns
    {
        ID,
        F_TransactionID,
        F_I_SBF_2ID,
    ...
    public enum F_I_SBF_5Procedure
    {
        p_F_I_SBF_5_Get_By_F_TransactionID,
    }
    public class F_I_SBF_5List : List<F_I_SBF_5>
    {
