...
{
    [Serializable]
    public class F_I_DTR_360 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_360"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_360_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_360Columns
    {
        ID,
        F_I_DTR_320ID,
        RecordType,
    ...
    public enum F_I_DTR_360Procedure
    {
        p_F_I_DTR_360_GetBy_F_I_DTR_320ID
    }
    public class F_I_DTR_360List : List<F_I_DTR_360>
    {
