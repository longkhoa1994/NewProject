...
{
    [Serializable]
    public class F_I_SBF_2 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public long F_I_SBF_1ID { get; set; }
        ...
        public override string Table { get { return "F_I_SBF_2"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_SBF_2_InsertOrUpdate"; } }
    }
    public enum F_I_SBF_2Columns
    {
        ID,
        F_TransactionID,
        F_I_SBF_1ID,
    ...
    public enum F_I_SBF_2Procedure
    {
        p_F_I_SBF_2_GetByTransactionId
    }
    public class F_I_SBF_2List : List<F_I_SBF_2>
    {
