...
{
    [Serializable]
    public class F_E_DTR_361 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long? _F_E_DTR_360ID;
        public long? F_E_DTR_360ID
        {
            get { return _F_E_DTR_360ID; }
            set { _F_E_DTR_360ID = value; }
        }
        ...
        public override string Table { get { return "F_E_DTR_361"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_361_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_361Columns
    {
        ID,
        F_E_DTR_360ID,
        RecordType,
    ...
    public enum F_E_DTR_361Procedure
    {
        p_F_E_DTR_361_GetBy_F_E_DTR_360ID
    }
    public class F_E_DTR_361List : List<F_E_DTR_361>
    {
