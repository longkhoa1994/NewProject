...
namespace T2P._2015.Cross.Model
{
    ...
    public class M_HotelPlatformSetting : BaseModel
    {
        ...
        private string _mailUsernameAlias;

        public string MailUsernameAlias
        {
            get { return _mailUsernameAlias; }
            set { _mailUsernameAlias = value; }
        }
        ...
        private int _isSmartBilling;

        public int IsSmartBilling
        {
    ...
    public enum M_HotelPlatformSettingProcedure
    {
        ...
        p_M_HotelPlatformSetting_GetByMailUsername
    }
    ...
    public class P_HotelPlatformSetting : M_HotelPlatformSetting
    {
