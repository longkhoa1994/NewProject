...
{
    [Serializable]
    public class F_I_GL1025_0 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_GL1025_0"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_GL1025_0_InsertOrUpdate"; } }
    }
    public enum F_I_GL1025_0Columns
    {
        ID,
        F_ImportFileID,
        RecordType,
    ...
    public enum F_I_GL1025_0Procedure
    {

    }
    public class F_I_GL1025_0List : List<F_I_GL1025_0>
    {
