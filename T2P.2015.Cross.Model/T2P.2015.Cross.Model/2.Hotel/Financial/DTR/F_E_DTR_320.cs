...
{
    [Serializable]
    public class F_E_DTR_320 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_E_DTR_320"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_DTR_320_InsertOrUpdate"; } }
    }
    public enum F_E_DTR_320Columns
    {
        ID,
        F_E_DTR_310ID,
        F_TransactionID,
    ...
    public enum F_E_DTR_320Procedure
    {
        p_F_E_DTR_320_GetBy_F_E_DTR_310ID
    }
    public class F_E_DTR_320List : List<F_E_DTR_320>
    {
