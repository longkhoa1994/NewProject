...
{
    [Serializable]
    public class F_I_SBF_4 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_SBF_4"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_SBF_4_InsertOrUpdate"; } }
    }
    public enum F_I_SBF_4Columns
    {
        ID,
        F_I_SBF_5ID,
        RecordTypeId,
    ...
    public enum F_I_SBF_4Procedure
    {
        p_F_I_SBF_4_Get_By_F_TransactionID,
    }
    public class F_I_SBF_4List : List<F_I_SBF_4>
    {
