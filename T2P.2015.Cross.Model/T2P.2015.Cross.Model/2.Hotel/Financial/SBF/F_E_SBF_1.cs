...
{
    [Serializable]
    public class F_E_SBF_1 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public long F_E_SBF_0_4287ID { get; set; }
        ...
        public override string Table { get { return "F_E_SBF_1"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_E_SBF_1_InsertOrUpdate"; } }
    }
    public enum F_E_SBF_1Columns
    {
        ID,
        F_E_SBF_0_4287ID,
        F_HeaderID,
    ...
    public enum F_E_SBF_1Procedure
    {
        p_F_E_SBF_1_GetBySBF_0_4287ID
    }
    public class F_E_SBF_1List : List<F_E_SBF_1>
    {
