...
namespace T2P._2015.Cross.Model
{
    ...
    public enum M_FileLocationProcedure
    {
        ...
        p_M_FileLocation_GetByFileLocationID,
        p_M_FileLocation_GetByImageFromFax,
        p_M_FileLocation_GetByM_CompanyID
    }
    ...
    public class M_FileLocationExtend : M_FileLocation
    {
        ...
        private string _iISSmartBillingLogo;
        public string IISSmartBillingLogo
        {
            get { return _iISSmartBillingLogo; }
            set { _iISSmartBillingLogo = value; }
        }
    }

    public class P_Company_Setting : M_FileLocation
    {
