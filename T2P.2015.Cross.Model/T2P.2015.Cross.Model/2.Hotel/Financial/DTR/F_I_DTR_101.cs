...
{
    [Serializable]
    public class F_I_DTR_101 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_101"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_101_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_101Columns
    {
        ID,
        F_ImportFileID,
        RecordType,
    ...
    public enum F_I_DTR_101Procedure
    {
        p_F_I_DTR_101_GetBy_F_ImportFileID
    }
    public class F_I_DTR_101List : List<F_I_DTR_101>
    {
