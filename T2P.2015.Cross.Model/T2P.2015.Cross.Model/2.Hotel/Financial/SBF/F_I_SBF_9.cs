...
{
    [Serializable]
    public class F_I_SBF_9 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long _f_I_SBF_0_4287ID;
        public long F_I_SBF_0_4287ID
        {
            get { return _f_I_SBF_0_4287ID; }
            set { _f_I_SBF_0_4287ID = value; }
        }
        ...
        public override string Table { get { return "F_I_SBF_9"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_SBF_9_InsertOrUpdate"; } }
    }
    public enum F_I_SBF_9Columns
    {
        ID,
        F_I_SBF_0_4287ID,
        RecordTypeID,
    ...
    public enum F_I_SBF_9Procedure
    {

    }
    public class F_I_SBF_9List : List<F_I_SBF_9>
    {
