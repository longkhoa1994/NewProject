...
{
    [Serializable]
    public class F_I_DTR_401 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        public override string Table { get { return "F_I_DTR_401"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_401_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_401Columns
    {
        ID,
        F_I_DTR_201ID,
        RecordType,
    ...
    public enum F_I_DTR_401Procedure
    {
        p_F_I_DTR_401_GetBy_F_I_DTR_201ID
    }
    public class F_I_DTR_401List : List<F_I_DTR_401>
    {
