...
{
    [Serializable]
    public class F_I_DTR_310 : BaseModel
    {
        private long _iD;
        public long ID
        {
        ...
        private long? _f_I_DTR_201ID;
        public long? F_I_DTR_201ID
        {
            get { return _f_I_DTR_201ID; }
            set { _f_I_DTR_201ID = value; }
        }
        ...
        public override string Table { get { return "F_I_DTR_310"; } }
        public override string PrimaryKey { get { return ID.ToString(); } }
        public override string InsertUpdateProcedure { get { return "p_F_I_DTR_310_InsertOrUpdate"; } }
    }
    public enum F_I_DTR_310Columns
    {
        ID,
        F_I_DTR_201ID,
        F_HeaderID,
    ...
    public enum F_I_DTR_310Procedure
    {
        p_F_I_DTR_310_GetByF_Header,
        p_F_I_DTR_310_GetBy_F_I_DTR_201ID
    }
    public class F_I_DTR_310List : List<F_I_DTR_310>
    {
