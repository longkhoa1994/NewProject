...
namespace T2P._2015.Cross.Model.Process
{
    ...
    public class P_TAccount_FIN
    {
        ...
        private bool _isSkipByInvoice;

        public bool IsSkipByInvoice
        {
            get { return _isSkipByInvoice; }
            set { _isSkipByInvoice = value; }
        }

        private bool _isSkipSCCR;

        public bool IsSkipSCCR
        {
            get { return _isSkipSCCR; }
            set { _isSkipSCCR = value; }
        }

        public P_TAccount_FIN()
        {
            IsSkipByInvoice = false;
            IsSkipSCCR = false;
        }
    }
    ...
    {
        private long r_RG_RateGridID;

        public long R_RG_RateGridID
        {
            get { return r_RG_RateGridID; }
            set { r_RG_RateGridID = value; }
        }

        public bool isSCCR { get; set; }
        public bool isDCI { get; set; }

        public bool isDC0 { get; set; }
        ...
        private bool _isSixtReplace;

        public bool IsSixtReplace
        {
            get { return _isSixtReplace; }
            set { _isSixtReplace = value; }
        }
